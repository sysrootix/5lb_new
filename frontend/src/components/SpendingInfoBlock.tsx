...
export const SpendingInfoBlock: FC = () => {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#4A2511]/80 to-[#180C06]/90 p-5 sm:p-6 shadow-lg border border-white/5 backdrop-blur-sm">
      {/* Watermark Logo */}
      ...
      <div className="relative z-10">
        <h3 className="text-lg sm:text-xl font-bold text-white mb-4">
          На что потратить 30 000 бонусов?
        </h3>
        
        <div className="space-y-3">
          {[
            { text: '1 бонус = 1 рубль.' },
            { text: 'Во время покупки вы можете использовать до 30% от стоимости товара.' }
          ].map((item, idx) => (
